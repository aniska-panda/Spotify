  ...
  return (
    <div className='relative w-full ml-12 '>
      <input
        ...
        className='bg-black-200 text-purple-950 w-[48rem] h-9 pl-6 rounded-3xl px-3 placeholder:text-slate-600 font-bold outline-none'
      />

      {isDropdownVisible && filteredSongs.length > 0 && (
        <div ref={dropdownRef} className='absolute bg-black border rounded-b-2xl mt-1 w-full max-h-40 overflow-y-auto z-10'>
